package ch.zhaw.sml.iwi.gpi.musterloesung.eks.helpers;
...
public class DefaultHeaderHelper {
    ...
    public DefaultHeaderHelper(HeaderType headerRequest) {
        ...
        headerResponse.setSenderId("sedex://einwohnerkontrollsystem");
        ...
        sendingApplication.setManufacturer("Gemeinde XYZ");
        
        // Diesem Objekt wird die Applikations-Bezeichnung zugewiesen
        sendingApplication.setProduct("EinwohnerKontrollSystem-Applikation");
