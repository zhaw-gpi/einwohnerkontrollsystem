...
public class WebServiceConfiguration {    
     ...
     * weiter definiert (einwohnerKontrollSystemService).
     * 
    ...
    public Endpoint jaxwsEndpoint() {
        ...
        endpoint = new EndpointImpl(springBus(), einwohnerKontrollSystemService());
        ...
        // zugegriffen werden
        endpoint.publish("/EinwohnerKontrollSystemService");
